...
# Date  : 2025-3-20
################################################################
from .generated.public_api_types_pb2 import BaseType
...
class Vehicle:
    def __init__(self, base_type: BaseType):
        ...
        elif base_type == BaseType.TripleOmniWheelLRDriver:
            print("Vehicle base type is TripleOmniWheelLRDriver.")
        elif base_type == BaseType.SteeringWheelPrototype:
            print("Vehicle base type is SteeringWheelPrototype.")
        elif base_type == BaseType.Mark1DiffBBDriver:
    ...
    def inverse_kinematic(self, v_x, v_y, v_r) -> list[float]:
        if self.base_type == BaseType.TripleOmniWheelLRDriver:
            d = self.track_width
            v = [0.0, 0.0, 0.0]
